...
curl    --key /etc/pki/tls/private/spgw-int-psn.probation.service.justice.gov.uk.key \
        ...
        --resolve spgw-ext-psn.probation.service.justice.gov.uk:9001:spgw-ext-psn.probation.service.justice.gov.uk \
        https://spgw-ext-psn.probation.service.justice.gov.uk:9001/cxf/InboundSPGProxy/1.2?wsdl -v