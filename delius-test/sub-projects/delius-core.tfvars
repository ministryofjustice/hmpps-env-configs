...
delius_app_config = {
  ...
  # OS Data Hub API Key
  secret_OS_DATAHUB_API_KEY = "/delius-test/delius/delius-application/osuk-datahub/api-key"
  # probation search
  ...
  env_PSR_SERVICE_URL               = "https://pre-sentence-service-dev.hmpps.service.justice.gov.uk/api/v1/report"
  env_PSR_UI_URL_FORMAT             = "https://pre-sentence-service-dev.hmpps.service.justice.gov.uk/psr/%s"
  ...
  env_COSSO_API_URL                 = "https://cosso-api-dev.hmpps.service.justice.gov.uk/cosso"
  env_COSSO_UI_URL_FORMAT           = "https://cosso-ui-dev.hmpps.service.justice.gov.uk/cosso/%s"
...
gdpr_config = {
  ...
  cron_retainedoffendersiicsa         = "-"                 # disabled, it was Run at 8am Monday to Friday
...
# Merge
merge_config = {
  api_min_capacity      = 0 # Merge Moved to CP
  api_max_capacity      = 0
  api_version           = "0.37.0"
  ui_min_capacity       = 0
  ui_max_capacity       = 0
