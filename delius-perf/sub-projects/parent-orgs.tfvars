...
PO_SPG_CONFIGURATION = {
  ...
  SPG_CERTIFICATE_PATH = "/official-data/hmpps-delius-perf/current/"

  #THERE IS NO C00 in ND prod yet, nor an assigned crc for testing
  PO_POSTUB_NAME = "PO STUB"
  PO_POSTUB_TLS_COMMON_NAME = "spgw-crc-ext.perf.probation.service.justice.gov.uk"
  PO_POSTUB_SIGNING_COMMON_NAME = "signing.spgw-crc-ext.perf.probation.service.justice.gov.uk"
  PO_POSTUB_CRC_LIST = "C00,C01,C02,C03,C04,C05,C06,C07,C08,C09,C10,C11,C12,C13,C14,C15,C16,C17,C18,C19,C20,C21"
  PO_POSTUB_ENDPOINT_URL = "https://spgw-crc-ext.perf.probation.service.justice.gov.uk:9001/cxf/CRC-100"
