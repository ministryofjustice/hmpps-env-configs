...
dfi_mp_datasync_s3_role     = "arn:aws:iam::471112751565:role/delius-mis-stage-datasync-s3-role"
...
db_size_mis_standby = {
  database_size       = "x_large"
  instance_type       = "r5.4xlarge"
  disks_quantity      = 8 # Do not decrease this; when increasing this value a new data/flash volume is created. Both vols have different iops so check with DBAs which type of vol is required as they might have to perform a volume swapping within ASM. Ticket ref. https://dsdmoj.atlassian.net/browse/NIT-706
...
nextcloud_nfs_access_cidrs         = ["10.27.0.0/24", "10.27.1.0/24", "10.27.2.0/24"]
nextcloud_efs_iam_mount_principals = ["arn:aws:iam::471112751565:root"]
