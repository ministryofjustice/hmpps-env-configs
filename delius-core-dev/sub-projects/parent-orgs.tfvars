...
PO_SPG_CONFIGURATION = {
  ...
  PO_POSTUB_TLS_COMMON_NAME = "spgw-crc-ext.dev.probation.service.justice.gov.uk"
  PO_POSTUB_SIGNING_COMMON_NAME = "signing.spgw-crc-ext.dev.probation.service.justice.gov.uk"
