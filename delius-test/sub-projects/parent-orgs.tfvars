...
PO_SPG_CONFIGURATION = {
  ...
  SPG_CERTIFICATE_PATH = "/unclassified-data/hmpps-delius-test/current/"

  #THERE IS NO C00 in ND prod yet, nor an assigned crc for testing
  PO_POSTUB_NAME = "PO STUB"
  PO_POSTUB_TLS_COMMON_NAME = "spgw-crc-ext.test.probation.service.justice.gov.uk"
  PO_POSTUB_SIGNING_COMMON_NAME = "signing.spgw-crc-ext.test.probation.service.justice.gov.uk"
